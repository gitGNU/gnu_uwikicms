...
function phpwiki_transform() {
   ...
   for ($index = 0; $index < $numlines; $index++) {
      ...
      /*
       * For UWiKiCMS we check if the line is composed of a single
       * [ img:123 ] link, this is used for a stupid hack which helps
       * validating XHTML 1.0 strict. The point is just not to open a
       * <p> tag for an image only, since img tags are embedded in a div.
       */
      $img_only = preg_match("/^\s*\[\s*img\s*\:\s*\d+\s*\][\s\r\n]*$/",$tmpline) ? 1 : 0;
...
*/
	...
	$oldn++;
      ...
      /*
       * We disable Wiki links in UWikiCms
      //////////////////////////////////////////////////////////
      // Link Wiki words
	...
	$ordinary_output=1;
      ...
      /*
       * We disable PHPWiki specific stuff in UWikiCms
